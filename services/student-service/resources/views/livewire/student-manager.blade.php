<div x-data="{ showDeleteModal: false, deleteId: null }">
                    ...
                    <tr class="hover:bg-slate-50 transition-colors">
                        ...
                        <td class="px-6 py-3.5 text-right">
                            <div class="inline-flex items-center gap-1">
                                ...
                                <button @click="deleteId = {{ $student->id }}; showDeleteModal = true"
    ...
    <div x-show="showDeleteModal" x-cloak
        ...
        <div class="bg-white rounded-xl shadow-2xl p-6 max-w-sm w-full mx-4" @click.outside="showDeleteModal = false"
            ...
            <p class="text-sm text-gray-600 mb-6">Are you sure you want to delete this student? This action cannot be undone.</p>
            <div class="flex items-center justify-end gap-3">
                ...
                <button @click="$wire.delete(deleteId); showDeleteModal = false" class="px-4 py-2 rounded-md text-sm font-medium bg-red-600 hover:bg-red-700 text-white transition-colors shadow-sm">Yes, Delete</button>
            </div>
        </div>
    </div>
</div>
