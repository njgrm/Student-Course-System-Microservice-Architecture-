<div x-data="{ showDeleteModal: false, deleteId: null }">
                    ...
                    <tr class="hover:bg-slate-50 transition-colors">
                        ...
                        <td class="px-6 py-3.5 text-right">
                            <div class="inline-flex items-center gap-1">
                                ...
                                <button @click="deleteId = {{ $course->id }}; showDeleteModal = true"
    ...
    <div x-show="showDeleteModal" x-cloak
        ...
        <div class="bg-white rounded-xl shadow-2xl p-6 max-w-sm w-full mx-4" @click.outside="showDeleteModal = false"
            ...
            <p class="text-sm text-gray-600 mb-6">Are you sure you want to delete this course? This action cannot be undone.</p>
